...
## Java-跨平台的语言
![image_3](../base/image_3.png)
## JVM-跨语言的平台
![image_4](../base/image_4.png)
...
2. GraalVM在HotSpot VM基础上增强而成的跨语言全栈虚拟机，可以作为“任何语言”的运行平台使用。语言包括：Java、Scala、Groovy、Kotlin；C、C++、Javascript、Ruby、Python、R等
